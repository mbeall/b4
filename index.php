	...
	<div id="main">
		<h2>
			<?php if ( is_home() or is_front_page() ) : ?>
				...
				<?php _e( 'Recent Updates', 'b4' ); ?> <?php if ( b4_get_page_number() > 1 ) printf( __( 'Page %s', 'b4' ), b4_get_page_number() ); ?>

			<?php else : ?>

				<?php printf( _x( 'Updates from %s', 'Month name', 'b4' ), get_the_time( 'F, Y' ) ); ?>

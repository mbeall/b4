 ...
 * in WordPress 3.4.
 *
 * @uses b4_header_style()
 * @uses b4_admin_header_style()
 *
 * @package B4
 * @since P2 1.4
 */
function b4_setup_custom_header() {
	add_theme_support( 'custom-header', apply_filters( 'b4_custom_header_args', array(
		'width'               => 980,
		'height'              => 120,
		'default-image'       => '',
		'default-text-color'  => '3478e3',
		'wp-head-callback'    => 'b4_header_style',
		'admin-head-callback' => 'b4_admin_header_style',
	) ) );
}
 ...
 * @since P2 1.1
 */
function b4_admin_header_style() {
?>
	<style type="text/css">
	#headimg {
 ...
 * @since P2 1.1
 */
function b4_header_style() {
?>
	<style id="b4-header-style" type="text/css">
